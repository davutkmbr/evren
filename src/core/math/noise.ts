/**
 * Deterministic procedural helpers shared by every generator (CPU side).
 * GPU equivalents live in render/shaders/common.glsl.ts.
 */
...
/** Integer hash of 2 ints -> [0, 1). Stable across runs. */
...
/** Simplex noise (2D/3D) with its own permutation table. Output ~[-1, 1]. */
