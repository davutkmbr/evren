...
import { buildDoubleEnder, buildSeabus, buildTourBoat, buildVapur, type BuiltModel } from './models/ferries';
import { buildCargoShip, type CargoDesign } from './models/cargo';
import { buildFishingBoat, buildMotorboat, buildSailboat, buildSeiner, buildYacht } from './models/small-craft';
import { buildPilotBoat, buildTug } from './models/workboats';
...
export const RECIPES: readonly ModelRecipe[] = [
  { key: 'vapur', kind: 'vapur', length: 72, beam: 13.2, draft: 3.1, big: true, lodDistance: 750, build: buildVapur },
  { key: 'seabus', kind: 'seabus', length: 38.5, beam: 11.2, draft: 1.35, big: true, lodDistance: 550, build: buildSeabus },
  { key: 'ferry', kind: 'ferry', length: 41.7, beam: 9.6, draft: 2.0, big: true, lodDistance: 600, build: buildDoubleEnder },
  { key: 'tour', kind: 'tour', length: 30, beam: 7.2, draft: 1.6, big: false, lodDistance: 420, build: buildTourBoat },
  { key: 'tug', kind: 'tug', length: 26, beam: 9.5, draft: 3.4, big: false, lodDistance: 420, build: buildTug },
  { key: 'pilot', kind: 'pilot', length: 16, beam: 4.8, draft: 1.2, big: false, lodDistance: 320, build: buildPilotBoat },
  { key: 'motorboat', kind: 'motorboat', length: 8.5, beam: 2.8, draft: 0.55, big: false, lodDistance: 240, build: buildMotorboat },
  ...
  { key: 'fishing', kind: 'fishing', length: 9.5, beam: 3.2, draft: 0.8, big: false, lodDistance: 260, build: buildFishingBoat },
