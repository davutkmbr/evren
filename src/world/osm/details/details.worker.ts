...
export function buildDetails(req: DetailsRequest): DetailsResult {
  ...
  const trees = placeTrees(data, { surface, cover, area: base.rect, pads, lines: req.lines, mosques: req.mosques, clearings: req.clearings, structures: req.infillClaims.structures });
