...
/**
 * Launch options of the GPU browser: system Chrome with Metal ANGLE, or, when EVREN_CHROME names a Chromium binary
 * (machines without Chrome or a GPU, e.g. cloud containers), that binary on SwiftShader (software WebGL: slow, fine
 * for framing shots, not for performance numbers).
 */
export function chromeLaunchOptions() {
  const exe = process.env.EVREN_CHROME;
  if (exe) {
