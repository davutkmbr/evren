...
const HEADERS = { 'User-Agent': 'evren-asset-fetch/1.0 (+https://github.com/davutkmbr/evren)' };
...
const SOURCE_LABEL = { polyhaven: 'Poly Haven', ambientcg: 'ambientCG', cgbookcase: 'cgbookcase', sketchfab: 'Sketchfab' };
...
[street-materials.md](candidates/street-materials.md#decision-${manifest.approved}) and
[cafe-street-props.md](candidates/cafe-street-props.md#decision-${manifest.approved}).
...
async function main() {
  ...
  const apiAssets = manifest.assets.filter((a) => a.download === 'api');
